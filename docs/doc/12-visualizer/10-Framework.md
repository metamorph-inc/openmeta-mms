...
<img src="images/filter_exact_entry.png" alt="Exact Entry" style="width: 408px;"/>
...
* **Remove Missing:** This removes rows from the dataset that are incomplete, i.e. one or more entries is missing data.
