...
namespace GME.CSharp
{
    ...
    abstract class ComponentConfig
    {
        ...
        public const string componentName = "CyPhyResultsViewer";

        // Specify an icon path
        public const string iconName = "CyPhyResultsViewer.ico";

        public const string tooltip = "Results Viewer";
        ...
        public const string progID = "MGA.Interpreter.CyPhyResultsViewer";
        public const string guid = "39431F15-F390-441F-824D-055DCB1EB101";
    }
}
