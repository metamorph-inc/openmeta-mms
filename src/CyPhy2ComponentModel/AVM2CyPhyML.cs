...
namespace AVM2CyPhyML
{
 ...
 ======= */
                            ...
                            {
                                connectAcrossHierarchy(cyPhyMLObjectSrc, cyPhyMLObjectDst, typeof(CyPhyML.SystemCParameterPortMap).Name);
                            }
                            else if (cyPhyMLObjectDst is CyPhyML.EDAModelParameter)
                            {
                                connectAcrossHierarchy(cyPhyMLObjectSrc, cyPhyMLObjectDst, typeof(CyPhyML.EDAModelParameterMap).Name);
                            }
