...
setup(name='AVMDDPLib', version='2.0', author='Adam Nagel', author_email='adam@isis.vanderbilt.edu',
 ...
 packages=['avm','avm.modelica','avm.cad','avm.manufacturing','avm.cyber','avm.schematic','avm.schematic.eda','avm.schematic.spice','avm.systemc', 'avm.rf', 'avm.domainmapping', 'iFAB'],
