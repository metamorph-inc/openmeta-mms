    ...
    <schematic xrefpart="/%S.%C%R" xreflabel="%F%N/%S.%C%R">
      ...
      <sheets>
        <sheet>
          ...
          <plain />
          <instances>
            <instance y="30.48" part="LED3" gate="G$1" x="53.34" />
            <instance y="38.10" part="LED4" gate="G$1" x="71.12" />
            <instance y="12.70" part="LED1" gate="G$1" x="15.24" />
            <instance y="53.34" part="LED2" gate="G$1" x="33.02" />
          </instances>
          <busses />
          <nets>
            <net name="N$0">
              <segment>
                <wire x1="53.34" y1="27.94" x2="50.80" y2="27.94" width="0.3" layer="91" />
                <label x="50.80" y="27.94" size="1.27" layer="95" />
                <pinref part="LED3" gate="G$1" pin="ANODE" />
              </segment>
              <segment>
                <wire x1="71.12" y1="35.56" x2="68.58" y2="35.56" width="0.3" layer="91" />
                <label x="68.58" y="35.56" size="1.27" layer="95" />
                <pinref part="LED4" gate="G$1" pin="ANODE" />
              </segment>
              <segment>
                <wire x1="15.24" y1="10.16" x2="12.70" y2="10.16" width="0.3" layer="91" />
                <label x="12.70" y="10.16" size="1.27" layer="95" />
                <pinref part="LED1" gate="G$1" pin="ANODE" />
              </segment>
            </net>
            <net name="N$1">
              <segment>
                <wire x1="53.34" y1="38.10" x2="50.80" y2="38.10" width="0.3" layer="91" />
                <label x="50.80" y="38.10" size="1.27" layer="95" />
                <pinref part="LED3" gate="G$1" pin="CATHODE" />
              </segment>
              <segment>
                <wire x1="71.12" y1="45.72" x2="68.58" y2="45.72" width="0.3" layer="91" />
