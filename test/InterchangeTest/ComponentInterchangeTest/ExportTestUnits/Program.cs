...
namespace ComponentExporterUnitTests
{
    public class Tests
    {
        ...
        {
            return Path.Combine(_exportModelDirectory, testName, "components/Components/cml_zodb/usr_classes/components_hull_frame_body_cab/Drawbar_Bolted/drawbar/drawbar.component.acm");
        }

        private string getHullAcmPath(string testName)
        {
            return Path.Combine(_exportModelDirectory, testName, "components/Components/cml_zodb/usr_classes/components_hull_frame_body_cab/Hull_Assembly_Example_With_Connector/hull/hull.component.acm");
        }
