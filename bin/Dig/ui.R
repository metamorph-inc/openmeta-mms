...
tabsetArguments <- c(unname(primaryTabs),
                     unname(addedTabs),
                     unname(finalTabs),
                     id = "inTabset")

# print(paste("names of primary tabs:", names(primaryTabs)))
# print(paste("number of primary tabs:", length(primaryTabs)))
# print(paste("primaryTabs:",primaryTabs[1]))
# 
# 
# 
# print(paste("length of primarypanels:", length(primaryTabs)))
# print(paste("length of addedpanels:", length(addedTabs)))
# print(paste("length of finalpanels:", length(finalTabs)))
# print(paste("length of tabpanels:", length(tabsetArguments)))
