          ...
          column(3,
            ...
            wellPanel(
              ...
              selectInput(ns("pairs_plot_marker"),
                          ...
                          c("Circle, Open"=1,
                            "Circle, Filled"=19),
                          selected=si("pairs_plot_marker", 1)),
              sliderInput(ns("pairs_plot_marker_size"), "Marker Size:",
                          min=0.5, max=2.5,
                          value=si("pairs_plot_marker_size",1),
                          step=0.025),
              hr(),
              h4("Info"),
          ...
          column(3,
            ...
            bsCollapse(id = "single_plot_collapse", open = "Variables",
              bsCollapsePanel("Variables", 
                selectInput(ns("x_input"), "X-axis", c(), selected=si("x_input", NULL)),
                selectInput(ns("y_input"), "Y-Axis", c(), selected=si("y_input", NULL)),
                style = "default"),
